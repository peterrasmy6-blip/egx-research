...
# ---------------------------------------------------------------------------
# The second batch, kept in its own file so each stays readable.
from .education_extra import EXTRA_GLOSSARY, EXTRA_LESSONS

GLOSSARY = GLOSSARY + EXTRA_GLOSSARY
LESSONS = LESSONS + EXTRA_LESSONS

# Alphabetical, because a glossary is looked up rather than read through.
